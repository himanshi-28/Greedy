...
import type { Attempt, PointsSource, Profile } from "@/lib/types";
...
export function LeaderboardClient({ profiles, attempts }: { profiles: Profile[]; attempts: Attempt[] }) {
      ...
      <div className="flex flex-wrap gap-2">
        {tabs.map((tab) => (
          <button
            ...
            className={cn(
              "h-10 rounded-md border border-black/10 px-4 text-sm font-bold transition hover:-translate-y-0.5 hover:shadow-panel",
